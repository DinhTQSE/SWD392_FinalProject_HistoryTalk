...
BEGIN
    IF EXISTS (
        ...
        WHERE table_schema = 'historical_schema'
        ...
        SELECT c.character_id, c.context_id
...
-- ============================================================
ALTER TABLE historical_schema."character" ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP NULL;
ALTER TABLE historical_schema.character_document ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP NULL;
ALTER TABLE historical_schema.historical_context ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP NULL;
ALTER TABLE historical_schema.historical_context_document ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP NULL;
ALTER TABLE historical_schema.chat_session ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP NULL;
ALTER TABLE historical_schema.message ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP NULL;
ALTER TABLE historical_schema.quiz_result ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP NULL;
ALTER TABLE historical_schema.quiz_answer_detail ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP NULL;
ALTER TABLE historical_schema.quiz_session ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP NULL;
ALTER TABLE historical_schema."user" ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP NULL;
