package com.historytalk.presentation.quiz.controller;
...
import com.historytalk.application.quiz.service.QuizService;
...
public class StaffQuizController {
    ...
    @SecurityRequirement(name = "bearerAuth")
    @Operation(summary = "Soft delete quiz result", description = "Soft delete a quiz result (Staff version)")
